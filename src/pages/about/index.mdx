...
import Spoiler from '@/custom/components/user/Spoiler.astro'
...
<Collapse title='Website history:'>
  <Timeline>
    <TimelineItem date="2025-11-08">
      加入<IconLink href="https://www.travellings.cn/train.html">开往</IconLink>
    </TimelineItem>
    <TimelineItem date="2025-09-17">
      从 <IconLink href="https://pages.cloudflare.com"> CloudFlare Pages </IconLink> 迁移到 <IconLink href="https://edgeone.cloud.tencent.com">Tencent EdgeOne CDN</IconLink>
    </TimelineItem>
    <TimelineItem date="2025-09-16" milestone>
      添加备案号
    </TimelineItem>
...
- Comment system: [Giscus](https://giscus.app), 欢迎来[[msgboard|留言板]]留言～
